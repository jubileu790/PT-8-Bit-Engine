...
#ifndef scanline_fx_start
#define scanline_fx_start    0
#endif
#ifndef scanline_fx_end
#define scanline_fx_end    143
#endif
#ifndef scanline_fx_chunksize
#define scanline_fx_chunksize    4
#endif
...
void scanline_isr(void) NONBANKED {
    ...
    if (LYC_REG <= scanline_fx_start || LYC_REG > scanline_fx_end) {
        ...
        SCX_REG = draw_scroll_x + (SIN((LYC_REG + game_time) * 4) >> 8);
        SCY_REG = draw_scroll_y;
    }
